...
public class UserBddSqlite extends SQLiteOpenHelper {
    ...
    private static final String CREATE_BDD =
            "CREATE TABLE "+TABLE_USER+
                    ...
                    +COL_PASSWORD+" TEXT NOT NULL, "+COL_NOM+" TEXT NOT NULL, "+COL_PRENOM+" TEXT NOT NULL, "+COL_WRITE+" TEXT NOT NULL, "+COL_ADMIN+" TEXT NOT NULL);";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //utilisateur admin
        db.execSQL("INSERT INTO table_user (EMAIL, NOM, PRENOM, PASSWORD, WRITE, ADMIN) VALUES ('admin@gmail.com', 'root', 'user', 'Test123*', 1, 1)");
